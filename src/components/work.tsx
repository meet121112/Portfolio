  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        <h2 className="text-3xl md:text-7xl font-bold tracking-tight text-white max-w-3xl leading-tight">
          Specialty <span className="text-primary italic">Frameworks</span>
        </h2>
        <p className="text-white/40 max-w-xl text-sm md:text-lg mt-2">
      ...
      <div className={cn(
        ...
        {projects.map((project, index) => (
          ...
          >
            <div className="relative h-full min-h-[400px] md:h-[460px] w-full p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-white/10 bg-black overflow-hidden flex flex-col justify-between transition-all duration-500 group-hover:border-primary/50 group-hover:bg-white/[0.02]">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl md:text-2xl font-bold leading-tight text-white transition-colors group-hover:text-primary uppercase tracking-tight">
                  {project.title}
                </h3>
              </div>
      ...
      <div className={cn(
        ...
        <Link href="/work">
          <Button variant="outline" className="h-12 md:h-14 px-8 md:px-12 rounded-2xl border-white/10 bg-white/5 text-white/70 hover:bg-white/10 hover:text-white hover:border-white/20 transition-all flex gap-3 group">
