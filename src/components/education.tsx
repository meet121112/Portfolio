          ...
          >
            <div className="space-y-6">
              <div className="flex justify-between items-start">
                <h3 className="text-2xl font-bold text-white tracking-tight leading-tight max-w-[220px] group-hover:text-primary transition-colors">
                  {item.course}
                </h3>
                <div className="w-12 h-12 rounded-2xl bg-primary/5 flex items-center justify-center border border-white/5 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">
                  {item.icon}
                </div>
              </div>
            ...
            <div className="pt-8 mt-8 border-t border-white/5 flex justify-between items-center">
              ...
              <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center transition-all duration-500 group-hover:bg-primary group-hover:border-primary group-hover:text-white shrink-0 ml-4">
                <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-0.5 group-hover:-rotate-45" />
              </div>
            </div>
